...
describe('favorite blog', () => {
  ...
  test('when list has multiple similar return first', () => {
    const result = listHelper.favoriteBlog(sameBlog);
    expect(result).toStrictEqual({
      title: 'Go To Statement Considered Harmful',
      author: 'Edsger W. Dijkstra',
      likes: 5
...
describe('most blogs', () => {
  ...
  test('when list has only one blog counts that', () => {
    const result = listHelper.mostBlogs(listWithOneBlog);
    expect(result).toStrictEqual({ author: 'Edsger W. Dijkstra', blogs: 1 });
  });

  test('when list has multiple similar calculates count', () => {
    const result = listHelper.mostBlogs(sameBlog);
...
describe('most likes', () => {
  ...
  test('when list has multiple similar calculates count', () => {
    const result = listHelper.mostLikes(sameBlog);
    expect(result).toStrictEqual({ author: 'Edsger W. Dijkstra', likes: 10 });
  });
